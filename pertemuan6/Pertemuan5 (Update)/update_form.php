<!-- Menjalankan query MySQL Select dan membuat sebuah data kelas menggunakan array -->
<?php
    include "koneksi.php";
    $kelas = ['SE-03A','SE-03B'];
    ...
    // Variabel untuk menghitung jumlah record
    $sqlTotal = "SELECT COUNT(id) as 'total' from data";
    $dataSqlTotal = $conn->query($sqlTotal);

    // melakukan select data sehingga data yang akan diedit dapat disajikan di layar
        ...
        <div class="row">
            ...
            <div class="col-lg-6">
                <h4 class="d-flex justify-content-between align-items-center mb-3">
                    ...
                    <!-- Menampilkan jumlah record data yang diinputkan -->
                    <?php foreach($dataSqlTotal as $total) : ?>

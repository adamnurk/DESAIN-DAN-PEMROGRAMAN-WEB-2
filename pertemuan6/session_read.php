<!-- Untuk menginput data yang ada disimpan pada session dan membaca data session -->
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<body>
    ...
    <!-- form untuk saat kita submit akan mengirimkan data ke halaman session_proccess.php -->
    ...
    Session yang tersimpan 2: <?php echo isset($_SESSION['session_tersimpan2'])?$_SESSION['session_tersimpan2']:'Session 2 Kosong' ?> <br>
